        ...
        <div className="p-6 flex flex-col flex-1">
          ...
          <div className="flex flex-wrap gap-1.5 mt-4">
            {automazione.stack.map((t) => (
              <span
                key={t}
                className="text-xs px-2.5 py-1 rounded-full bg-cyan-electric/8 border border-cyan-electric/20 text-cyan-electric/80"
              >
                {t}
              </span>
            ))}
    ...
    <section id="automazioni" className="py-24 bg-navy">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="section-subtitle">
          6 workflow completi che dimostrano competenze reali in automazione, integrazione API e intelligenza artificiale applicata.
        </p>
